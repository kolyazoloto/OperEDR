...
def make_ion_density(filename,start='000000',end='235959', graph_num=1, save=0):
    ...
    for i in range(graph_num):
        ...
        #Нормируем cbar
        normalize = mpl.colors.Normalize(vmax=1.9e5)
        #
        ...
        #colorbar
        cbar = plt.colorbar()
        cbar.set_label(r'$\mathrm{Ion\ density,\ Ion/сm^3}$',fontsize=14)
        #Подпищем оси
...
make_ion_density(os.getcwd()+'\\XPERIMENT\\'+dates[0],'131500','141000',graph_num=1, save=1)
